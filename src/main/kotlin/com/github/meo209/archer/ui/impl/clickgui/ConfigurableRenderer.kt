...
import com.github.meo209.archer.ui.impl.clickgui.renderers.BooleanRenderer
import com.github.meo209.archer.ui.impl.clickgui.renderers.IntRenderer
import com.github.meo209.archer.ui.impl.clickgui.renderers.KeybindingRenderer
import com.github.meo209.archer.ui.impl.clickgui.renderers.StringRenderer
import kotlin.reflect.KClass

interface ConfigurableRenderer<T : Configurable<*>> {

    fun render(configurable: T)

}

object RendererFactory {

    private val map: Map<KClass<out Configurable<*>>, ConfigurableRenderer<*>> = mapOf(
        BooleanConfigurable::class to BooleanRenderer(),
        IntConfigurable::class to IntRenderer(),
        KeybindingConfigurable::class to KeybindingRenderer(),
        StringConfigurable::class to StringRenderer()
    )

    fun create(kConfigurable: Configurable<*>): ConfigurableRenderer<*> {
        return map
            .entries
            .firstOrNull { it.key == kConfigurable::class }!!
            .value
    }
